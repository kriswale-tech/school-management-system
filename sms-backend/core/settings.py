...
SECRET_KEY = 'django-insecure-j@7)g#=w221!e04+^xp08%7!r63%8y7m2gkk51q%lr8lr*3_ci'
...
STUDENT_BULK_IMPORT_FAILURE_TTL = timedelta(hours=24)
STUDENT_BULK_IMPORT_MAX_FILE_SIZE = 5 * 1024 * 1024  # 5 MB
STUDENT_BULK_IMPORT_MAX_ROWS = 1000

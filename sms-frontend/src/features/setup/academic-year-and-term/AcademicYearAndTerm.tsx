...
import AcademicYearAndTermForm from './components/AcademicYearAndTermForm'
import type {
  AcademicYearAndTerm as AcademicYearAndTermType,
  AcademicYearAndTermFormData,
} from './types'
import { getAcademicYearAndTerm, updateAcademicYearAndTerm } from './services'
import { mapFormToApiPayload } from './utils'
